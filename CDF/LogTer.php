...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        $fb = new Facebook\Facebook([
            'app_id' => '147732975794995', // Replace {app-id} with your app id
        ...
        $loginUrl = $helper->getLoginUrl('https://redes2-171719.appspot.com/FBTerCallback.php', $permissions);
        ?>
        <div class="main">
            <div class="header_bg">
                <div class="header">
            ...
            <div class="header_text_bg2">
                <div class="header_text">
                    ...
                    <h2>Intranet Panel de Terapeutas</h2>
            ...
            <div class="body_resize">
                <div class="body">
                    <div class="body_big">
                        ...
                        <form name="loginForm" action="ConTer.php" method="post" id="loginForm" enctype="multipart/form-data">
                            <ol>
                                <li>
